package com.devrebel.powerlib.core.config.email;

import com.devrebel.powerlib.app.domain.settings.Settings;
import com.devrebel.powerlib.app.domain.settings.SettingsRepository;
